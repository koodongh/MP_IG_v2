...
def run_():
    process_read = os.popen("ps -ef | grep _run.py | grep -v 'grep'").readlines()
    ...
    # 문자열로 변환한다.
    text_location=check_process.find("_run.py")

    if ( text_location == -1 ):
        print("Process not found!")
        path = '/home/user/cam/share/Python'
        os.chdir(path)
        os.system("sudo python3 /home/user/cam/share/Python/_run.py &")
...
def run_1():
    ...
    if ( text_location == -1 ):
        ...
        path = '/home/user/cam/share/Python'
        os.chdir(path)
        os.system("sudo python3 /home/user/cam/share/Python/main.py &")
        # 해당 프로그램을 다시 실행한다. 백그라운드에서 실행할 경우 &기호를 붙인다.
        print("Program restarted!")
    else:
        print("Process exists. Location is",text_location)
